...
- [PDF: Cartilla de la Defensoría](https://drive.google.com/file/d/1xs_NzBzR2KT5Pev7OOMbyeJtz-1EzKnw/view). Explica los derechos específicos de las personas trans, procedimientos médicos y legales, etc. Está completo, con fallos de corte y marco legal. [(Clic aquí para versión resumida que sólo tiene el tema médico, legal y situación militar)](https://drive.google.com/file/d/1eFX-ZCO5xoQVXYPuHD9PVPnNdcT_lrKS/view).
- [PDF: Cartilla de la Universidad Javeriana con información sobre la Terapia Hormonal Feminizante](https://drive.google.com/file/d/11B6jSgUFJ6iMqeulDtL2PUfUmERreEKP/view), mencionando algunos medicamentos disponibles en Colombia. Este documento describe el consenso médico que concierne a todo el tratamiento de afirmación de género en Colombia.

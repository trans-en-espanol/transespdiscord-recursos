...
Importante: Si ves mensajes 'bot' escribiendo como una persona "normal" en [el servidor de Trans en Español](https://servidor.transespdiscord.net), es una persona plural que usa [el bot PluralKit](https://pluralkit.me/) para comunicarse. También conviene preguntar a cada sistema como debes referirte a sus miembros.

...
* [Guía de trámites para la atención a personas Trans en el servicio público](https://sgg.jalisco.gob.mx/sites/sgg.jalisco.gob.mx/files/guia_de_tramites_para_la_atencion_a_personas_trans_en_el_servicio_publico_en_jalisco_0.pdf). Si bien especifica que es para Jalisco, se aplica a todos los estados.
